    ...
    reference() {
        ...
        if (this.sequelizePath.references && typeof this.sequelizePath.references !== 'string') {
            if (this.sequelizePath.references.model && typeof this.sequelizePath.references.model !== 'string') {
                return (_b = (_a = this.sequelizePath.references) === null || _a === void 0 ? void 0 : _a.model) === null || _b === void 0 ? void 0 : _b.tableName;
            }
            return (_c = this.sequelizePath.references) === null || _c === void 0 ? void 0 : _c.model;
        }
        return null;
    }
    availableValues() {
